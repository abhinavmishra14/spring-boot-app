...
@Schema(title="Post Details", description="Contains all details of a user's posts")
public class PostModel {
	 ...
	 */
	public PostModel(final int identifier, final String content, final Date timestamp) {
		super();
