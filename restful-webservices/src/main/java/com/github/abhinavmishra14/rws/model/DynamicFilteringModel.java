...
/**
 * The Class DynamicFilteringModel.
 */
...
public class DynamicFilteringModel {
	 ...
	 */
	public DynamicFilteringModel(final String propOne, final String propTwo, final String propThree) {
		super();
