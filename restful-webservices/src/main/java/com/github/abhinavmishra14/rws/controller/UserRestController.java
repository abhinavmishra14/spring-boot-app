...
import com.github.abhinavmishra14.rws.exceptions.RestfulWSException;
...
public class UserRestController {
	 ...
	 * Id is autogenerated if not provided in request
	 * 
	...
	public ResponseEntity<Response> createUsers(@RequestBody final List<User> users) {
		...
		if (users != null && !users.isEmpty()) {
			...
			throw new RestfulWSException(String.format("Failed to create user(s) for the given input: %s", users));
		}
	}
	...
	public ResponseEntity<Response> deleteUser(@PathVariable final int id) {
		...
		if (id > 0) {
			...
			throw new RestfulWSException(String.format("User id '%s' is invalid!", id));
		}
	}
}
